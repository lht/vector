...
fn setup_localstack_for_partial_failures() {
    unsafe {
        ...
        std::env::set_var("KINESIS_LATENCY_RANGE_MS", "100-500"); // Variable latency
        std::env::set_var("LOCALSTACK_KINESIS_PROVIDER", "kinesis-mock"); // Use kinesis-mock for more realistic behavior
    }
}
